...
admin_change_ann = InlineKeyboardButton('Режим активации объявлений', callback_data='markup_admin_change_ann')
...
admin_change_sum = InlineKeyboardButton('Режим активации резюме', callback_data='markup_admin_change_sum')
markup_admin_change_sum = InlineKeyboardMarkup().row(admin_change_sum)
